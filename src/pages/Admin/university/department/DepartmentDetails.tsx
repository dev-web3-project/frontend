...
const DepartmentDetails = () => {
    ...
    return (
        <section className="content">
            <BreadCrumb title={department.name ? department.name : 'Loading...'} page_name="Cours" parent_name="Université" />
                        ...
                        <div className="card card-primary card-outline card-outline-tabs">
                            <div className="card-header p-0 border-bottom-0">
                                <ul className="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                                    ...
                                    <li className="nav-item">
                                        <a className="nav-link" id="custom-tabs-four-courses-tab" data-toggle="pill" href={"#custom-tabs-four-courses"} role="tab" aria-controls="custom-tabs-four-courses" aria-selected="false">Cours</a>
                                    </li>
                                    <li className="nav-item">
